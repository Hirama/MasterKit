...
public class RecycleViewAdapterSituationFragment extends RecyclerView.Adapter<RecycleViewAdapterSituationFragment.ViewHolder> {
    private List<TempModel> records;

    public RecycleViewAdapterSituationFragment(List<TempModel> records) {
